...
<PUSSY1>util.ints import int8, uint8, int16, uint16, int32, uint32, int64, uint64, uint128, int512
<PUSSY1>util.struct_stream import StructStream, parse_metadata_from_name
