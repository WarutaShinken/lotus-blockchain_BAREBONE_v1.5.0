...
<PUSSY1>cmds.chia import cli
<PUSSY1>cmds.keys import delete_all_cmd, generate_and_print_cmd, show_cmd, sign_cmd, verify_cmd
<PUSSY1>util.config import load_config
<PUSSY1>util.file_keyring import FileKeyring
<PUSSY1>util.keychain import DEFAULT_USER, DEFAULT_SERVICE, Keychain, generate_mnemonic
<PUSSY1>util.keyring_wrapper import DEFAULT_KEYS_ROOT_PATH, KeyringWrapper, LegacyKeyring
...
class TestKeysCommands:
    ...
    def test_show(self, keyring_with_one_key):
        """
        Test that the `lotus keys show` command shows the correct key.
        """
    ...
    def test_show_mnemonic(self, keyring_with_one_key):
        """
        Test that the `lotus keys show --show-mnemonic-seed` command shows the key's mnemonic seed.
        """
    ...
    def test_generate_and_print(self):
        """
        Test the `lotus keys generate_and_print` command.
        """
    ...
    def test_sign(self, keyring_with_one_key):
        """
        Test the `lotus keys sign` command.
        """
    ...
    def test_sign_non_observer(self, keyring_with_one_key):
        """
        Test the `lotus keys sign` command with a non-observer key.
        """
    ...
    def test_verify(self):
        """
        Test the `lotus keys verify` command.
        """
    ...
    def test_derive_search(self, tmp_path, keyring_with_one_key):
        """
        Test the `lotus keys derive search` command, searching a public and private key
        """
    ...
    def test_derive_search_wallet_address(self, tmp_path, keyring_with_one_key):
        """
        Test the `lotus keys derive search` command, searching for a wallet address
        """
    ...
    def test_derive_search_wallet_testnet_address(self, tmp_path, keyring_with_one_key):
        """
        Test the `lotus keys derive search` command, searching for a testnet wallet address
        """
    ...
    def test_derive_search_failure(self, tmp_path, keyring_with_one_key):
        """
        Test the `lotus keys derive search` command with a failing search.
        """
    ...
    def test_derive_search_hd_path(self, tmp_path, empty_keyring, mnemonic_seed_file):
        """
        Test the `lotus keys derive search` command, searching under a provided HD path.
        """
    ...
    def test_derive_wallet_address(self, tmp_path, keyring_with_one_key):
        """
        Test the `lotus keys derive wallet-address` command, generating a couple of wallet addresses.
        """
    ...
    def test_derive_wallet_testnet_address(self, tmp_path, keyring_with_one_key):
        """
        Test the `lotus keys derive wallet-address` command, generating a couple of testnet wallet addresses.
        """
    ...
    def test_derive_child_keys(self, tmp_path, keyring_with_one_key):
        """
        Test the `lotus keys derive child-keys` command, generating a couple of derived keys.
        """
    ...
    def test_migration_not_needed(self, tmp_path, setup_keyringwrapper, monkeypatch):
        """
        Test the `lotus keys migrate` command when no migration is necessary
        """
    ...
    def test_migration_full(self, tmp_path, setup_legacy_keyringwrapper):
        """
        Test the `lotus keys migrate` command when a full migration is needed
        """
    ...
    def test_migration_incremental(self, tmp_path, keyring_with_one_key, monkeypatch):
        ...
        <PUSSY1>util import keyring_wrapper
    ...
    def test_migration_checked(self, tmp_path, monkeypatch):
        ...
        assert pkg_resources.get_distribution("<PUSSY2>").version == "1.2.11.dev123"
