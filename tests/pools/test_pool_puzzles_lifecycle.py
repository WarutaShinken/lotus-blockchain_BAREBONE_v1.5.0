...
<PUSSY1>wallet.puzzles.p2_conditions import puzzle_for_conditions
<PUSSY1>wallet.puzzles import singleton_top_layer
<PUSSY1>pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - <PUSSY5>pools.pool_puzzles.py
    - <PUSSY5>wallet.puzzles.pool_member_innerpuz.clvm
    - <PUSSY5>wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
