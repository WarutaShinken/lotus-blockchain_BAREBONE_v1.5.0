...
<PUSSY1>wallet.nft_wallet.ownership_outer_puzzle import puzzle_for_ownership_layer
<PUSSY1>wallet.nft_wallet.transfer_program_puzzle import puzzle_for_transfer_program
<PUSSY1>wallet.outer_puzzles import (
    construct_puzzle,
    create_asset_id,
    get_inner_puzzle,
    get_inner_solution,
