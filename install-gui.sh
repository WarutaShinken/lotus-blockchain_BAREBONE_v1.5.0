...
# Allows overriding the branch or commit to build in <PUSSY2>-gui
SUBMODULE_BRANCH=$1
...
# https://github.com/Chia-Network/<PUSSY2>/pull/10460#issuecomment-1054492495
...
if [ ! "$CI" ]; then
  ...
  # Set modified output of `lotus version` to version property of GUI's package.json
