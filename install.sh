...
if [ "$(uname -m)" = "armv7l" ]; then
  ...
  echo "https://github.com/Chia-Network/<PUSSY2>/wiki/Raspberry-Pi"
  echo "Exiting."
  exit 1
fi
# Get submodules
...
python -m pip install --extra-index-url https://pypi.<PUSSY5>net/simple/ miniupnpc==2.2.2
python -m pip install -e ."${EXTRAS}" --extra-index-url https://pypi.<PUSSY5>net/simple/

echo ""
echo "Chia blockchain install.sh complete."
echo "For assistance join us on Keybase in the #support chat channel:"
echo "https://keybase.io/team<PUSSY5>_network.public"
echo ""
echo "Try the Quick Start Guide to running <PUSSY2>:"
echo "https://github.com/Chia-Network/<PUSSY2>/wiki/Quick-Start-Guide"
echo ""
