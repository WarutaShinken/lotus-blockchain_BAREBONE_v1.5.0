...
rm -rf <PUSSY2>-gui/build || true
rm -rf <PUSSY2>-gui/daemon || true
rm -rf <PUSSY2>-gui/node_modules || true
rm <PUSSY2>-gui/temp.json || true
( cd "$PWD/<PUSSY2>-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
