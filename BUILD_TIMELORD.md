...
required to run a [Timelord](https://github.com/Chia-Network/<PUSSY2>/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Chia-Network/<PUSSY2>/blob/main/install-timelord.sh)
