...
<PUSSY1>cmds.passphrase_funcs import prompt_for_passphrase, read_passphrase_from_file
<PUSSY1>util.default_root import DEFAULT_KEYS_ROOT_PATH
<PUSSY1>util.file_keyring import FileKeyring
<PUSSY1>util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE, KeyringWrapper
