...
<PUSSY1>util.default_root import DEFAULT_KEYS_ROOT_PATH
<PUSSY1>util.file_keyring import FileKeyring
<PUSSY1>util.misc import prompt_yes_no
...
def check_legacy_keyring_keys_present(keyring: LegacyKeyring) -> bool:
    ...
    <PUSSY1>util.keychain import default_keychain_user, default_keychain_service, get_private_key_user, MAX_KEYS
...
class KeyringWrapper:
    ...
    def __init__(self, keys_root_path: Path = DEFAULT_KEYS_ROOT_PATH, force_legacy: bool = False):
        ...
        """
        <PUSSY1>util.keychain import KeyringNotSet
    ...
    def _configure_backend(self) -> Union[LegacyKeyring, FileKeyring]:
        <PUSSY1>util.keychain import supports_keyring_passphrase
    ...
    def _get_initial_cached_passphrase(self) -> str:
        ...
        """
        <PUSSY1>util.keychain import supports_os_passphrase_storage
    ...
    def confirm_migration(self) -> bool:
        ...
        if master_passphrase == DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE:
            ...
            if response:
                <PUSSY1>cmds.passphrase_funcs import prompt_for_new_passphrase
    ...
    def migrate_legacy_keys(self) -> MigrationResults:
        <PUSSY1>util.keychain import get_private_key_user, Keychain, MAX_KEYS
    ...
    def migrate_legacy_keyring_interactive(self):
        ...
        """
        <PUSSY1>cmds.passphrase_funcs import async_update_daemon_migration_completed_if_running
