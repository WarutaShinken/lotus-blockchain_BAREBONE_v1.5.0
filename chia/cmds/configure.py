...
<PUSSY1>util.config import lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, "config.yaml") as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet10.<PUSSY5>net"
                testnet_dns_introducer = "dns-introducer-testnet10.<PUSSY5>net"
                bootstrap_peers = ["testnet10-node.<PUSSY5>net"]
                testnet = "testnet10"
                ...
                mainnet_port = "8444"
                mainnet_introducer = "introducer.<PUSSY5>net"
                mainnet_dns_introducer = "dns-introducer.<PUSSY5>net"
                bootstrap_peers = ["node.<PUSSY5>net"]
                net = "mainnet"
