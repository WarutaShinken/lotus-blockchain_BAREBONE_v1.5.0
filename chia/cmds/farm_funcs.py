...
<PUSSY1>util.misc import format_bytes
<PUSSY1>util.misc import format_minutes
<PUSSY1>util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total lotus farmed: {amounts['farmed_amount'] / units['chia']}")
