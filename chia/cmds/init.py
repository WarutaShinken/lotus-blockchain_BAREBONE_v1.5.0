...
@click.option("--testnet", is_flag=True, help="Configure this lotus install to connect to the testnet")
...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, testnet: bool, v1_db: bool, **kwargs):
    ...
    - Make a copy of your Farming Machine CA directory: ~/.<PUSSY3>[version]/config/ssl/ca
    ...
    - Get more details on remote harvester on Chia wiki:
      https://github.com/Chia-Network/<PUSSY2>/wiki/Farming-on-many-machines
    """
    from pathlib import Path
    from .init_funcs import init
    <PUSSY1>cmds.passphrase_funcs import initialize_passphrase
