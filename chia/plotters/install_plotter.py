import os
<PUSSY1>plotters.bladebit import install_bladebit
<PUSSY1>plotters.madmax import install_madmax
...
def install_plotter(plotter, root_path):
    if plotter == "chiapos":
        ...
        if not os.path.exists(root_path / "madmax-plotter/build<PUSSY5>_plot"):
